...
class BrainNexus:
    ...
    def run(self, input_data: Any, trace_execution: bool = True) -> Dict[str, Any]:
        ...
        try:
            ...
            # Step 1: Controller determines judge probabilities
            step_start = time.time()
            controller_result = self._run_controller_phase(input_data, execution_trace)
            if execution_trace:
    ...
    def _run_handler_phase(self, reviewer_results: Dict[str, Any], controller_result: Dict[str, Any], 
        ...
        """Handler combines reviewer probabilities with controller weights."""
        ...
        if self.demo:
            ...
            print(f"      Used {final_result['num_reviewers_used']} reviewers, total weight: {final_result['total_weight']:.3f}")
    ...
    def _format_output(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Args:
            result: Raw result from handler phase
            
        Returns:
            Formatted result based on output configuration
        """
