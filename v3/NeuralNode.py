import random
import numpy as np
from computations import Judge, Controller, Splitter, Computational, Repeater, Reviewer, Retainer, Handler, Placeholder
class NeuralNode:
    def __new__(cls, node_id, node_type, node_position, demo=False):
        ...
        if node_type == 'Controller':
            ...
            return Computational(node_id, node_position, embed_dim=128, demo=demo)
            ...
            return Placeholder(node_id, node_position, demo=demo)
        else:
